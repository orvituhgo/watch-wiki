...
export default function Details() {
    ...
    return (
        <>
            ...
            {data && (<CardDetails
                src={primaryImage ? primaryImage.url : 'https://via.placeholder.com/300x450/cccccc/969696?text=Image+not+found'} altText={`View of ${titleText.text} scene`}
                titleTitle={titleText ? titleText.text : 'title not found'}
                titleDescription={plot ? plot.plotText.plainText : 'summary not found'}
                rating={ratingsSummary && ratingsSummary.aggregateRating ? ratingsSummary.aggregateRating : 'not rated enough'}
